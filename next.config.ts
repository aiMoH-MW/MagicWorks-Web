    ...
    return [
      {
        ...
        headers: [
          ...
          // Basic CSP — allows self, trusted CDNs, and Google/Meta/Vercel services
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com https://connect.facebook.net https://www.clarity.ms https://va.vercel-scripts.com https://www.magicflowai.io",
              ...
              "connect-src 'self' https://wa86etuq.api.sanity.io https://*.supabase.co https://www.google-analytics.com https://analytics.google.com https://va.vercel-scripts.com https://www.magicflowai.io https://*.magicflowai.io",
