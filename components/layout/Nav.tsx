    ...
    >
      <nav className="max-w-[1120px] mx-auto px-8 py-[14px] flex items-center justify-between">
        ...
        <Link href="/" className="flex items-end gap-2 no-underline">
          <Image src="/logo-header.webp" alt="MagicWorks IT Solutions" width={144} height={112} className="h-14 w-auto object-contain" priority sizes="(max-width: 640px) 80px, 128px" />
