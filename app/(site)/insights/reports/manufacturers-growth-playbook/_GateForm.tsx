...
const PDF_URL = "/reports/MagicWorks_Manufacturers_Growth_Playbook.pdf";
    ...
    try {
      await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          message: `Role: ${role || "not specified"}. Requested: Manufacturer's Growth Playbook`,
          source_page: "playbook-manufacturers-growth",
          _gotcha: gotcha,
        }),
      });
      trackLeadSubmit("playbook-manufacturers-growth");
      setDone(true);
    } catch {
    ...
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="mb-4">
        ...
        >
          ...
          <option>Founder / MD / Director</option>
          <option>Sales or business head</option>
