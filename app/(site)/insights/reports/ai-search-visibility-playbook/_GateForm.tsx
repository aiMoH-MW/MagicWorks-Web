...
const PDF_URL = "/reports/MagicWorks_AI_Search_Visibility_Playbook.pdf";
    ...
    try {
      await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          message: `Role: ${role || "not specified"}. Requested: AI Search Visibility Playbook`,
          source_page: "playbook-ai-search-visibility",
          _gotcha: gotcha,
        }),
      });
      trackLeadSubmit("playbook-ai-search-visibility");
      setDone(true);
    } catch {
