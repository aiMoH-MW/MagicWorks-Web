...
const PDF_URL =
  "https://drive.google.com/uc?export=download&id=10wkLheVJJWdHFH0h9EsopURSjzBHyJet";
    ...
    try {
      await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          message: `Role: ${role || "not specified"}. Requested: AI-Native Website Spec Sheet`,
          source_page: "spec-sheet-ai-native-website",
          _gotcha: gotcha,
        }),
      });
      setDone(true);
    ...
    <form onSubmit={handleSubmit} noValidate>
      ...
      <div className="mb-4">
        ...
        >
          ...
          <option>Marketing or growth head</option>
          <option>Product or project lead</option>
          <option>Other</option>
        </select>
      </div>
      ...
      >
        {submitting ? "Sending…" : "Send me the spec sheet"}
      </button>
