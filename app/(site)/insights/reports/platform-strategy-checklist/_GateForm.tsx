...
const PDF_URL =
  "https://drive.google.com/uc?export=download&id=1ZiAp1PKmvMECgTVS9U0TPfSPqVG3_7z5";
    ...
    try {
      await fetch("/api/leads", {
        ...
        body: JSON.stringify({
          ...
          message: `Role: ${role || "not specified"}. Requested: Platform Strategy Checklist`,
          source_page: "checklist-platform-strategy",
          _gotcha: gotcha,
        }),
      });
      setDone(true);
