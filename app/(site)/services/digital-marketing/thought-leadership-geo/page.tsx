          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <h2 className="font-[family-name:var(--font-head)] font-bold text-[clamp(24px,3.4vw,32px)] text-[#2A1B5C] mb-4">
                Become the authority AI engines cite by name.
              </h2>
              <p className="text-[17px] leading-[1.6] text-[#3F3F4A] mb-6">
                Tell us about your expertise and audience and we will outline what a sustained thought-leadership programme would build over twelve months.
              </p>
              <ul className="space-y-3 text-[15px] text-[#3F3F4A]">
                ...
                <li className="flex gap-3 items-start"><span className="text-[#D4A537] font-bold mt-[2px]">&#10003;</span>AI citation tracking is a measured output, not a promise</li>
            ...
            <DigitalMarketingContactForm
              sourcePage="/services/digital-marketing/thought-leadership-geo"
              defaultService="Thought Leadership & GEO"
            />
          </div>
        </div>
      </section>
